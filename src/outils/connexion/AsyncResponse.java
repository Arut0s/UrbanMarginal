...
public interface AsyncResponse {
	 ...
	 * @param ordre contient "connexion" si nouvelle connexion, "r�ception" si nvelle information re�ue, "déconnexion" si déconnexion
	 * @param info contient l'information re�ue (si ordre = "réception")
	 */
